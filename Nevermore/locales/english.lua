...
L.popup_disableui = "Nevermore doesn't work for this resolution, do you want to disable Nevermore? (Cancel if you want to try another resolution)"
L.popup_install = "First time running Nevermore V13 with this Character. You must reload your UI to set Action Bars, Variables and Chat Frames."
L.popup_reset = "Warning! This will reset everything to Nevermore default. Do you want to proceed?"
...
L.core_welcome1 = "Welcome to |cffC495DDNevermore|r, version "
L.core_welcome2 = "Type |cff00FFFF/uihelp|r for more info or visit www.Nevermore.org"
...
L.core_uihelp9 = "|cffFF0000/resetui|r - Reset Nevermore to default."
...
L.install_header_11= "4. Characters Class Roll"
L.install_header_12= "5. Success!"

-- install
L.install_init_line_1 = "Thank you for choosing Nevermore!"
...
L.install_init_line_3 = "You are also given the possibility to be shown a brief tutorial on some of the features of Nevermore."
...
-- tutorial 1
L.tutorial_step_1_line_1 = "This quick tutorial will show you some of the features in Nevermore."
L.tutorial_step_1_line_2 = "First, the essentials that you should know before you can play with this UI."
L.tutorial_step_1_line_3 = "This installer is partially character-specific. While some of the settings that will be applied later on are account-wide, you need to run install script for each new character running Nevermore. Script is auto show on every new character logging into Nevermore for the first time. Also, the options can be found in /Nevermore/config/config.lua for `Power` users or by typing /Nevermore in game for `Friendly` users."
L.tutorial_step_1_line_4 = "A power user is a user of a personal computer who has the ability to use advanced features (ex: Lua editing) which are beyond the abilities of normal users. A friendly user is a normal user and is not necessarily capable of programming. It's recommended for them to use our in game configuration tool (/Nevermore) for settings what they want displayed on Nevermore."

-- tutorial 2
L.tutorial_step_2_line_1 = "Nevermore includes an embedded version of oUF (oUFNevermore) created by Haste. This handles all of the unitframes on the screen, the buffs and debuffs, and the class-specific elements."
...
-- tutorial 3
L.tutorial_step_3_line_1 = "Nevermore is a redesigned Blizzard UI. Nothing less, nothing more. Approx all features you can see on Default UI is available thought Nevermore. The only features not available thought default UI are some automated features not really visible on screen, like example auto selling gray when visiting a vendor or, another example, auto sort items in bags."
L.tutorial_step_3_line_2 = "Because not everyone is enjoying things like DPS meters, Boss mods, Threat meter, etc, we judge that it's the best thing to do. Nevermore is made around this idea to fit at maximum all class, roles, specs, type of gameplay, taste of users, etc. That's why Nevermore is one of the most popular UI at the moment. It fit everyone gameplay and is extremly editable. It's also designed to be a very good start for everyone that want to make their own custom UI without depending on addons. Tons of users since 2009 are now using Nevermore as a base for their own UI. Take a look into our Edited Packages from our website!"
...
-- tutorial 5
L.tutorial_step_5_line_1 = "Lastly, Nevermore includes useful slash commands. Below is a list."
...
L.tutorial_step_6_line_2 = "I suggest you have a look through config/config.lua or by typing /Nevermore to customize the UI to your needs."
...
-- install step 1
L.install_step_1_line_1 = "These steps will apply the correct CVar settings for Nevermore."
...
-- install step 4
L.install_step_4_line_1 = "Choose Your Primary Class Roll\n( THIS IS CHARACTER SPECIFIC )"
L.install_step_4_line_2 = "Heal - Healing Players"
L.install_step_4_line_3 = "Tank - Protecting Players"
L.install_step_4_line_4 = "DPS - Damaging Enemies"
L.install_button_heal = "HEAL"
L.install_button_tank = "TANK"
L.install_button_dps = "DPS"

-- install step 5
L.install_step_5_line_1 = "Installation is complete."
L.install_step_5_line_2 = "Please click the 'Finish' button to reload the UI."
L.install_step_5_line_3 = ""
L.install_step_5_line_4 = "Enjoy Nevermore! Visit us at www.Nevermore.org!"
...
-- general
L.general = "General"
L.generalautoscale = "Auto UI Scale"
L.generaloverridelowtohigh = "Use High resolution  layout on a Lower resolution"
L.generalmultisampleprotect = "Multisampling protection (clean 1px border)"
L.generaluiscale = "UI Scale (if auto-scale is disabled)"
L.generalbackdropcolor = "Set default backdrop color of panels"
L.generalbordercolor = "Set default border color of panels"
L.generalblizzardreskin = "Reskin Blizzard frames to match Tukui"
 
-- nameplate
L.nameplate = "Nameplates"
L.nameplateenable = "Enable Nameplates"
L.nameplateenhancethreat = "Enable threat feature, automatically changes by your role"
L.nameplateshowhealth = "Show health on nameplate"
L.nameplatecombat = "Only show enemy nameplates in-combat"
L.nameplategoodcolor = "Good threat color, varies depending if your a tank or dps/heal"
L.nameplatebadcolor = "Bad threat color, varies depending if your a tank or dps/heal"
L.nameplatetransitioncolor = "Losing/Gaining threat color"
 
-- merchant
L.merchant = "Merchant"
L.merchantsellgrays = "Auto sell grey items"
L.merchantautorepair = "Auto Repair items"
L.merchantsellmisc = "Sell some defined (craps not grey) items automatically"
 
-- bags
L.bags = "Bags"
L.bagsenable = "Enable all-in-one bag"
 
-- datatext
L.datatext = "Data Text"
L.datatexttime24 = "Enable 24h time"
L.datatextlocaltime = "Use Local Time instead of Server Time"
L.datatextbattleground = "Enable Battleground Stats"
L.datatexthps_text = "Healing per second, position (0 for disabled)"
L.datatextguild = "Guild position (0 for disabled)"
L.datatext_arp = "Armor penetration position (0 for disabled)"
L.datatextsystem = "Memory position (0 for disabled)"
L.datatextbags = "Bags position (0 for disabled)"
L.datatextfontsize = "Font size of text"
L.datatextfps_ms = "Latency and FPS position (0 for disabled)"
L.datatextarmor = "Armor Position (0 for disabled)"
L.datatextavd = "Avoidance position (0 for disabled)"
L.datatextpower = "Power position (0 for disabled)"
L.datatexthaste = "Haste position (0 for disabled)"
L.datatextfriends = "Friends position (0 for disabled)"
L.datatextwowtime = "Time position (0 for disabled)"
L.datatextgold = "Gold position (0 for disabled)"
L.datatextdps_text = "Damage per second position (0 for disabled)"
L.datatextcrit = "Crit % position (0 for disabled)"
L.datatextdur = "Durability position (0 for disabled)"
L.datatextcurrency = "Currency position (0 for disabled)"
L.datatextmicromenu = "Micro Menu position (0 for disabled)"
L.datatexthit = "Hit position (0 for disabled)"
L.datatextmastery = "Mastery position (0 for disabled)"
L.datatexttalent = "Display talents (0 for disabled)"
L.datatextcalltoarms = "Call to Arms & Dungeons (0 for disabled)"
L.datatextregen = MANA_REGEN_ABBR
L.unitframesmovecombobar = "Move the combo bar from target (ROGUE ONLY)"
L.unitframesclassiccombo = "Use classic combo point"
L.unitframesgridvertical = "Display raid groups on Grid vertically"

 
-- unit frames
L.unitframes = "Unit Frames"
L.unitframescombatfeedback = "Combat Feedback on player and target"
L.unitframesrunebar = "Enable rune bar for Death Knight"
L.unitframesauratimer = "Enable timer on auras"
L.unitframestotembar = "Enable totem bar for Shaman"
L.unitframesshowtotalhpmp = "Display total of health/power"
L.unitframesshowplayerinparty = "Show yourself in party"
L.unitframesraidunitdebuffwatch = "Enable PVE raid Aura Watch (Grid Only)"
L.unitframesunitcastbar = "Enable cast bar"
L.unitframestargetauras = "Enable target auras"
L.unitframessaveperchar = "Save unit frames position per character"
L.unitframesplayeraggro = "Enable aggro display on yourself"
L.unitframesshowsmooth = "Enable smooth bar"
L.unitframescharportrait = "Enable portraits on player and target"
L.unitframesenable = "Enable Tukui Unit Frames"
L.unitframestargetpowerpvponly = "Enable Power display on enemy only"
L.unitframesgridonly = "Enable Grid only mode for Healer layout"
L.unitframeshealcomm = "Enable healcomm"
L.unitframesfocusdebuff = "Enable Focus debuffs"
L.unitframesaggro = "Enable aggro display on party/raid"
L.unitframesshowboss = "Enable Boss Unit Frames"
L.unitframesenemyhcolor = "Color enemy health bar by hostility (for PVP)"
L.unitframesgridhealthvertical = "Show health bar vertically for Grid layout"
L.unitframesshowsymbols = "Show symbols on party/raid"
L.unitframesthreatbar = "Enable threat bar"
L.unitframesshowrange = "Enable party/raid Range alpha display"
L.unitframesfocus = "Enable Focus target"
L.unitframescblatency = "Show cast bar latency"
L.unitframescbicons = "Show icons on cast bar"
L.unitframesplayerauras = "Enable an alternative aura mode for player"
L.unitframesauratextscale = "Aura text scale on auras"
L.unitframesgridscale = "Grid Scale"
L.unitframesmanahigh = "High mana indicator (For Hunters)"
L.unitframeslowthreshold = "Low mana indicator (All mana class)"
L.unitframesalphaoor = "Alpha on Party/Raid unit out of range"
L.unitframesmaintank = "Enable Main Tank"
L.unitframesmainassist = "Enable Main Assist"
L.unitframesunicolor = "Enable Unique color theme (grey health bar)"
L.unitframestotdebuffs = "Enable Target of Target debuffs (High Reso)"
L.unitframesclassbar = "Enable class bar"
L.unitframesweakenedsoulbar = "Enable Weakened Soul bar notification (Priest)"
L.unitframesonlyselfdebuffs = "Display only our debuffs on target"
L.unitframesshowfocustarget = "Enable Focus target"
L.unitframesbordercolor = "Set default border color of panels"
 
-- loot
L.loot = "Loot"
L.lootlootframe = "Enable loot window"
L.lootautogreed = "Enable auto-greed for green item at max level"
L.lootrolllootframe = "Enable item roll window"
 
-- invite
L.invite = "Invite"
L.inviteautoaccept = "Enable Auto-Invite (Friends and Guildmates)"
 
-- tooltip
L.tooltip = "Tooltip"
L.tooltipenable = "Enable tooltip"
L.tooltiphidecombat = "Hide tooltip in combat"
L.tooltiphidebuttons = "Hide tooltip on action bar buttons"
L.tooltiphideuf = "Hide tooltip on unit frames"
L.tooltipcursor = "Enable cursor tooltip"
 
-- error
L.error = "Error Message"
L.errorenable = "Hide spamming error in the middle of your screen"
 
-- action bar
L.actionbar = "Action Bars"
L.actionbarhideshapeshift = "Hide Shapeshift bar or Totem bar"
L.actionbarshowgrid = "Always show Grid on action bar"
L.actionbarenable = "Enable Tukui action bar"
L.actionbarrb = "Enable right bar on mouseover"
L.actionbarhotkey = "Show hotkey on buttons"
L.actionbarssmo = "Shapeshift bar or Totem bar on mouseover"
L.actionbarrbn = "Number of action bars on the bottom (1 or 2)"
L.actionbarrn = "Number of action bars on right (0, 1, 2 or 3)"
L.actionbarbuttonsize = "Size of the main action buttons"
L.actionbarbuttonspacing = "Spacing of the main action buttons"
L.actionbarpetbuttonsize = "Size of pet/shapeshift buttons"
L.actionbarownshdbar = "Use an empty bar for shadow dance (rogue) instead of stealth bar"
 
-- arena
L.arena = "Arena"
L.arenaunitframes = "Enable arena unit frames"
 
-- cooldowns
L.cooldown = "Cooldowns"
L.cooldownenable = "Enable cooldown number on buttons"
L.cooldowntreshold = "Turn cooldown number red at X value"
 
-- chat
L.chat = "Chat"
L.chatenable = "Enable Tukui Chat"
L.chatwhispersound = "Play sound when receiving private message"
L.chatbackground = "Enable chat panel background"

-- buff
L.auras = "Auras"
L.aurasplayer = "Enable Tukui Buff/Debuff Frames"
L.aurasconsolidate = "Enable Consolidate Buffs"
L.aurasflash = "Enable flashing animation on aura less than 30 seconds"

-- buttons
L.option_button_reset = "Reset"
L.option_button_load = "Apply Settings"
L.option_button_close = "Close"
L.option_setsavedsetttings = "Set settings Per-Character"
L.option_resetchar = "Are you sure you want to reset your character's settings to match your default settings?"
L.option_resetall = "Are you sure you want to reset all of your settings to Default?"
L.option_perchar = "Are you sure you want to change to or from 'Per Char Settings'?"
L.option_makeselection = "You must make a selection before you can continue to config."
