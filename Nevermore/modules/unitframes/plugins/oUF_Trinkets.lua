...
--[[
## Interface: 40000
## Title: |cffCC3333oUF|r|cff4f4f4f_Trinkets
## Notes: Adds PvP trinket status to oUF frames.
## Author: Allez
## Version: 40000.1-Beta
## Edit: Duffed, but Karudon's idea! :P
## X-Category: oUF
## Dependencies: oUF
]]--
	...
	elseif event == "ARENA_OPPONENT_UPDATE" then
		...
		if type == "seen" then
			if UnitExists(unit) and UnitIsPlayer(unit) and arenaFrame[unit] then
				...
				arenaFrame[unit].Trinket.Icon:SetTexture("Interface\\Buttons\\WHITE8x8")
				arenaFrame[unit].Trinket.Icon:SetVertexColor(0,.6,0) -- green
			end
		end
