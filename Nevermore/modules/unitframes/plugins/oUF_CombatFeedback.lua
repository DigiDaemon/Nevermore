...
--[[
## Interface: 30300
## Title: |cffCC3333oUF|r|cff4f4f4f_Combat Feedback
## Notes: Adds combat feedback to oUF.
## Author: Ammo
## Version: 1.0
## X-Category: UnitFrame
## Dependencies: oUF
## X-Curse-Packaged-Version: r40-release
## X-Curse-Project-Name: oUF_CombatFeedback
## X-Curse-Project-ID: o-uf_combat-feedback
## X-Curse-Repository-ID: wow/o-uf_combat-feedback/mainline
]]--
