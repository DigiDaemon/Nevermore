...
if ( C and C["media"] and C["media"]["uffont"] ) then
	...
	-- Sets font for all texts
	MASTER_FONT = { [=[Interface\Addons\Nevermore\media\Russel Square LT.ttf]=], 12, "OUTLINE" };

	-- Sets font for stack count
	STACKS_FONT = { [=[Interface\Addons\Nevermore\media\Russel Square LT.ttf]=], 11, "OUTLINE" };
end
...
local CLASS_FILTERS = {
		...
		HUNTER = { 
			...
			player = {
				...
				CreateSpellEntry( 19506 ), -- Trueshot Aura
			},
			procs = {
		...
		PRIEST = {
			target = {
				...
				CreateSpellEntry( 79105 ), -- Power Word: Fortitude
				CreateSpellEntry( 79107 ), -- Shadow Protection
...
if ( LAYOUT == 1 ) then
	...
	local frame = CreateAuraBarFrame( dataSource, iPlayer );
	local yOffset = 1;
	if ( playerClass == "DEATHKNIGHT" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
		yOffset = yOffset + 8;
	end
	frame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOMLEFT", 0, yOffset );
	frame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOM", 0, yOffset );
	frame:Show(); 
elseif ( LAYOUT == 2 ) then
	...
	local playerFrame = CreateAuraBarFrame( playerDataSource, iPlayer );	
	playerFrame:SetHiddenHeight( -yOffset );
	if ( playerClass == "DEATHKNIGHT" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
		playerFrame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOMLEFT", 0, yOffset + 8 );
		playerFrame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOM", 0, yOffset + 8 );
	else
		playerFrame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOMLEFT", 0, yOffset );
		playerFrame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOM", 0, yOffset );
	end
	playerFrame:Show();

	local targetFrame = CreateAuraBarFrame( targetDataSource, iPlayer );
...
elseif ( LAYOUT == 3 ) then
	...
	playerFrame:SetHiddenHeight( -yOffset );
	if ( playerClass == "DEATHKNIGHT" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
		playerFrame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOMLEFT", 4, yOffset );
		playerFrame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOM", -4, yOffset );
	else
		playerFrame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOMLEFT", 4, yOffset );
		playerFrame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOM", -4, yOffset );
	end
	...
	local trinketFrame = CreateAuraBarFrame( trinketDataSource, iPlayer );
	trinketFrame:SetHiddenHeight( -yOffset );
	trinketFrame:SetPoint( "BOTTOMLEFT", playerFrame, "TOPLEFT", 4, yOffset );
	trinketFrame:SetPoint( "BOTTOMRIGHT", playerFrame, "TOPRIGHT", 4, yOffset );
	trinketFrame:Show();
	...
	if event == "ADDON_LOADED" and arg1 == "Nevermore" then
		for k,v in pairs(NevermoreDataPerChar) do
  			if k == "role" and v == "dps" then
				...
				playerFrame:SetHiddenHeight( -yOffset );
				if ( playerClass == "DEATHKNIGHT" or playerClass == "SHAMAN" or playerClass == "PALADIN" or playerClass == "DRUID" or playerClass == "WARLOCK") then
				playerFrame:SetPoint( "BOTTOMLEFT", iPlayer, "TOPLEFT", 4, yOffset + (iPlayer:GetHeight() * 2.1));
				playerFrame:SetPoint( "BOTTOMRIGHT", iPlayer, "TOPRIGHT", -4, yOffset + (iPlayer:GetHeight() * 2.1));
				else
				playerFrame:SetPoint( "BOTTOMLEFT", iPlayer, "TOPLEFT", 4, yOffset + (iPlayer:GetHeight() * 2.1));
				playerFrame:SetPoint( "BOTTOMRIGHT", iPlayer, "TOPRIGHT", -4, yOffset + (iPlayer:GetHeight() * 2.1));
				end
				...
				local targetFrame = CreateAuraBarFrame( targetDataSource, iPlayer );		
				targetFrame:SetPoint( "BOTTOMLEFT", iTarget, "TOPLEFT", 0, yOffset + (iPlayer:GetHeight() * 2.1) );
				targetFrame:SetPoint( "BOTTOMRIGHT", iTarget, "TOPRIGHT", 0, yOffset + (iPlayer:GetHeight() * 2.1) );
				targetFrame:Show();
			end
  			if k == "role" and v == "heal" then
				...
				local targetFrame = CreateAuraBarFrame( targetDataSource, iPlayer );		
				targetFrame:SetPoint( "BOTTOMLEFT", NevermoreInfo, "BOTTOM", 0, yOffset );
				targetFrame:SetPoint( "BOTTOMRIGHT", NevermoreInfo, "BOTTOMRIGHT", 0, yOffset );
				targetFrame:Show();
			end
