...
local AltPowerBar = CreateFrame("Frame", "NevermoreAltPowerBar", NevermoreInfoLeft)
...
local AltPowerBarStatus = CreateFrame("StatusBar", "NevermoreAltPowerBarStatus", AltPowerBar)
...
AltPowerBarStatus:Point("TOPLEFT", NevermoreInfoLeft, "TOPLEFT", 2, -2)
AltPowerBarStatus:Point("BOTTOMRIGHT", NevermoreInfoLeft, "BOTTOMRIGHT", -2, 2)

local AltPowerText = AltPowerBarStatus:CreateFontString("NevermoreAltPowerBarText", "OVERLAY")
